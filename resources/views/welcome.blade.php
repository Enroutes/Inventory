...
<h1  style="font-family: 'Monoton', cursive;" class="center blue-text">INV-EXTRA</h1>
   ...
   <img   src="{{asset('storage/images/banner1.jpg')}}" alt="">
       ...
       <footer class="page-footer black" style="z-index:-1">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                <h5 class="white-text">INV-EXTRA</h5>
          ...
          <div class="footer-copyright">
            ...
            <a class="grey-text text-lighten-4 right" href="#!">Developed And Designed By Build & Prosper.</a>
            </div>
          </div>
        </footer>
